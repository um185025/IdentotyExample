...
namespace AlohaAPIExample.AlohaAPIConnection
{
    public interface IAlohaAPIClient
    {
        ...
        Task<OutRootMenusDTO> GetMenus(List<MenuItemOverride> menuItemOverrideList, int siteId, DateTime? promiseTime, OrderModeType? orderMode, bool includeInvisible = false);
